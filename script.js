...
//Create a funciton called `animalSounds`

//return the following values vased on the animal (string) that is passed in
//cow = moo
//dog = woof
//cat = meow
//alligator = snap snap

//Otherwise, display `we don't have that animal in the petting zoo.`
